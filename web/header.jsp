<%-- 
    Document   : header.jsp
    Created on : 24 Dec, 2020, 12:31:59 PM
    Author     : karan
--%>
...
<script>
    ...
    function searchfun()
    {
        ...
        if (keyword != "")
        {
            ...
            xhr.open("GET", "search_logic?" + querystring, true);
            xhr.send();
    ...
    <div class="container">
        ...
        <div class="product_list_header">  
            <form action="#" method="post" class="last"> 
                ...
                %>
                <button class="w3view-cart" type="submit"  onclick="gotoviewcart()" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
                    <%                            }
                    %>
            </form>  
        </div>
    ...
    <div class="container">
        ...
        <div class="w3l_search">
            <form action="#" method="post">
                <input type="search" id="searchkeyword" onkeyup="searchfun()"name="Search" placeholder="Search for a Product..." required="">
